...
package("godotcpp")
set_sourcedir(path.join(os.scriptdir(), "godot-cpp"))
add_deps("scons")
on_install("linux", "windows", "macosx", "mingw", "cygwin", "iphoneos", "android", "msys", function(package)
  local config = { "custom_api_file=./extension_api.json" }
  table.insert(configs, "bits=64")
...
target("myfirst2dgamebycpp")
set_kind("shared")
add_packages("godotcpp")
set_rundir("demo/bin")
